...
# Main parameters
VIDEO_DIRECTORY = os.path.abspath(f'/home/klab/Desktop/FaceEmotionDetection/inputs')
SUBJECT_FACE_IMAGE_FOLDER = os.path.abspath(f'/home/klab/Desktop/FaceEmotionDetection/deepface')
OUTPUT_DIRECTORY = os.path.abspath(f'/home/klab/Desktop/FaceEmotionDetection/outputs_Combined/') 
OUTPUT_DIRECTORY_PARTIAL_VERIFY = os.path.abspath(f'/home/klab/Desktop/FaceEmotionDetection/outputs_Combined_PatData/') 
