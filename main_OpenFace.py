...
for i in all_videos:
  ...
  subprocess.Popen(f"C:\Users\DannyHuang\Desktop\OpenFace_2.2.0_win_x64\OpenFace_2.2.0_win_x64\FeatureExtraction.exe -f '{video_path}' -out_dir '{OUTPUT_DIRECTORY}' -aus", shell=True)
