...
# Ordered AUs are: 1, 2, 4, 5, 6, 7, 9, 11, 12, 14, 15, 17, 20, 23, 24, 25, 26, 27, 28, 43
# TODO: Need to figure out the actual missing AU within PyFeat documentation! Filled in 27 for now.
au_order = [1, 2, 4, 5, 6, 7, 9, 11, 12, 14, 15, 17, 20, 23, 24, 25, 26, 27, 28, 43]
au_activations = {
